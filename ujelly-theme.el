...
(let ((class '((class color) (min-colors 89)))
      ...
      (custom-theme-set-faces
       ...
       `(font-lock-constant-face ((,class (:foreground ,ujelly-red-0))))
       ...
       `(ivy-minibuffer-match-face-2 ((,class (:foreground ,ujelly-red-0))))
       `(ivy-minibuffer-match-face-3 ((,class (:foreground ,ujelly-red-0))))
       `(ivy-minibuffer-match-face-4 ((,class (:foreground ,ujelly-red-0))))
       ...
       `(magit-diff-file-heading-highlight ((,class (:weight normal :foreground ,ujelly-fg))))
       `(magit-diff-hunk-heading ((,class (:foreground ,ujelly-yellow-0))))
       `(magit-diff-hunk-heading-highlight ((,class (:foreground ,ujelly-yellow-0))))
